...
class PgMemberCompleteRestConverter constructor(
    ...
    override fun mapToRestModel(obj: PgMember) = PgMemberRestModel(
        id = obj.id,
        pg = if (obj.pg == null) null else pgRestConverter.mapToRestModel(obj.pg!!),
        pgId = obj.pgId,
    ...
    override fun mapToEntity(obj: PgMemberRestModel) = PgMember(
        id = obj.id,
        pg = if (obj.pg == null) null else pgRestConverter.mapToEntity(obj.pg!!),
        pgId = obj.pgId,
