...
class PgMemberCompleteEntityConverter @Autowired constructor(
    ...
    override fun mapToModel(obj: PgMember) = PgMemberModel(
        id = obj.id,
        pg = if (obj.pg == null) null else pgEntityConverter.mapToModel(obj.pg!!),
        pgId = obj.pgId,
    ...
    override fun mapToEntity(obj: PgMemberModel) = PgMember(
        id = obj.id,
        pg = if (obj.pg == null) null else pgEntityConverter.mapToEntity(obj.pg!!),
        pgId = obj.pgId,
